...
What I am doing here is to draw a `circle packing` chart with only one level of hierarchy. You just represent each entity or
individual of your dataset with a circle, its size depending on a provided value. You need `packcircles` package to draw a
